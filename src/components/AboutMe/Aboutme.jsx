    ...
    <div className="relative">
      ...
      <div className="border rounded-2xl p-4 backdrop-blur bg-transparent ">
        ...
        <p className="font-bigjohn-regular text-xl my-4 text-justify">
          ...
          pursuing my Bachelor's degree in Computer Science at FAST University.
          With a GPA of 3.22 and a strong focus on both theoretical and
          practical aspects of the field, I'm dedicated to continuous learning
          and applying my skills in real-world scenarios. <br />
          <br /> Feel free to explore my portfolio to see some of the work I’ve
          done, and don’t hesitate to reach out if you’d like to collaborate or
